...
button.addEventListener('click', () => {
    ...
    }else if (dobInput.value > new Date()) {
        result.textContent='please input a valid date of birth';
     }
    ...
    function updateCountdown(){
        ...
        Next birthday in: </br>
        <strong>${d}</stong>d <strong>${h}</strong>h <strong>${m} </strong>m <strong>${s}</strong>s`;
    }
